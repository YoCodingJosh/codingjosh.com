...
<WorkHistoryItem title="Software Engineer III" industry="Healthcare Technology - Hospice and Palliative" skills={['Ruby', 'Rails', 'TypeScript', 'Angular', 'SQL', 'Docker']}
  ...
  * Added filters and features to report generation pages to allow for more granular reporting.
...
<WorkHistoryItem title="Software Developer" industry="Smart Transportation" startDate="September 2018" endDate="December 2018" wasContract="true"
...
<WorkHistoryItem title="Software Engineer" industry="Food and Vending" startDate="April 2016" endDate="July 2017"
  skills={['PHP', 'Elixir', 'Python', 'SQL', 'Angular', 'TypeScript', 'JavaScript', 'Bootstrap', 'jQuery', 'SaltStack', 'Node.js', 'Express.js']}
  tldr="Full stack web development using PHP and Elixir">
  * Worked on various back office web applications using PHP, Elixir, Node.js, and Angular.
  * Deployed applications uing Amazon Web Services and SaltStack.
  * Maintained Python CLI-based support tools.
  * Accomplishement: Designed, architected, and implemented an Elixir-based SSO service using Phoenix to interface mulitple legacy PHP applications.
</WorkHistoryItem>
